    ...
    <>
      <main className="mx-auto w-full max-w-5xl flex-1 px-5 pt-10 pb-16 sm:px-8 sm:pt-14">
        <section className="mt-10 max-w-3xl sm:mt-14">
          {/*
           * The wordmark and the member badge both live in the site header now,
           * so the page opens on the sentence rather than repeating the mark
           * immediately under it.
           */}
          <h1 className="font-display text-3xl leading-[1.25] sm:text-4xl md:text-5xl">
