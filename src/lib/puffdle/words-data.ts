// Curated list of common 5-letter English target words for Puffdle (canonical Wordle solution set).
export const PUFFDLE_TARGET_WORDS: readonly string[] = [
  ...
  "slump", "slate", "scour", "whack", "press", "route", "ghost", "dread", "fella", "squib",
  "climb", "crept", "flack", "sniff", "pulse", "stomp", "grief", "snopy", "cairn", "pupil",
  "dodge", "scoot", "hasty", "clove", "swung", "stony", "shrew", "plump", "frock", "clung",
  "splay", "screw", "spurt", "snack", "graft", "cower", "crock", "twist", "faint", "pasty",
  "spire", "plank", "grove", "twang", "stare", "crump", "flock", "clink", "sweep", "bough",
  "stiff", "braid", "twixt", "shrug", "snarl", "clash", "crawl", "blink", "brisk", "frost",
  "gloom", "spark", "flick", "tread", "gland", "prick", "drift", "flair", "plaid", "stalk",
  "shuck", "flint", "slant", "prank", "trunk", "creed", "graft", "craft", "spore", "plume",
  "crisp", "swamp", "brunt", "stray", "blunt", "crisp", "track", "trout", "spear", "prong",
  "stump", "clerk", "flute", "spill", "creak", "graze", "bluff", "crook", "blare", "flirt",
  "grape", "fluff", "spoke", "spite", "crepe", "brawn", "clasp", "flail", "spine", "brawl",
  "spoil", "snort", "brace", "pluck", "spark", "cramp", "fleet", "scoff", "scowl", "fluke",
  "brand", "crouch", "crane", "plush", "clout", "stunt", "blend", "smack", "smell", "smile",
  "smirk", "smoke", "snare", "sneak", "sneer", "snide", "snore", "snout", "solid", "solve",
  "sonar", "sonic", "sooth", "sound", "sourly", "south", "space", "spade", "speak", "speed",
  "spell", "spelt", "spelt", "spoon", "sport", "spout", "squad", "squat", "stage", "staid",
  "stain", "stair", "stake", "stale", "stalk", "stall", "stamp", "stare", "stark", "steak",
  "steal", "steam", "steel", "steep", "steer", "stein", "stern", "stick", "stile", "still",
  "stilt", "sting", "stock", "stoic", "stoke", "stole", "stone", "stood", "store", "storm",
  "story", "stout", "stove", "strap", "straw", "stray", "strip", "strum", "strut", "style",
  "sugar", "suite", "sulky", "sully", "sunny", "super", "surge", "surly", "sushi", "swami",
  "swarm", "swear", "sweat", "swede", "sweet", "swell", "swept", "swift", "swill", "swine",
  "swipe", "swirl", "swoop", "sword", "sworn", "syrup", "table", "taboo", "tacit", "taint",
  "taken", "taker", "tally", "talon", "tamer", "tango", "tangy", "taper", "tapir", "tardy",
  "taste", "tasty", "taunt", "tawny", "teach", "tease", "teddy", "teeth", "tempo", "tenet",
  "tenor", "tense", "tenth", "tepee", "tepid", "terse", "testy", "thank", "theft", "their",
  "theme", "there", "these", "thick", "thief", "thigh", "thing", "think", "third", "thorn",
  "those", "three", "threw", "throb", "throw", "thrum", "thumb", "thump", "thyme", "tiara",
  "tibia", "tidal", "tiger", "tight", "tilde", "timer", "timid", "tipsy", "titan", "tithe",
  "title", "toast", "today", "toddy", "token", "tonal", "tongs", "tonic", "tooth", "topaz",
  ...
  "twice", "twigs", "twill", "twine", "twins", "twirl", "twist", "tying", "udder", "ulcer",
  ...
  "yeast", "yield", "young", "youth", "zebra", "zesty", "zonal", "aback", "abase", "abate",
  ...
  "coyly", "cozen", "crack", "craft", "cramp", "crane", "crank", "crash", "crass", "crate",
  ...
  "eager", "eagle", "early", "earth", "easel", "eaten", "eater", "ebony", "eclat", "edema",
  ...
  "extra", "exult", "eying", "fable", "facet", "faint", "fairy", "faith", "false", "fame",
  ...
  "lathe", "latte", "laugh", "layer", "leach", "leafy", "leak", "leant", "leapt", "learn",
  ...
  "loamy", "loath", "lobby", "local", "locus", "lodge", "lofty", "logic", "login", "loop",
  ...
  "obese", "occur", "ocean", "ochre", "octal", "octet", "odder", "oddly", "offal", "offer",
  ...
  "stray", "strip", "strut", "stuck", "study", "stuff", "stump", "stung", "stunt", "style",
  "sugar", "sulky", "sully", "sumac", "sunny", "super", "surer", "surge", "surly", "sushi",
  ...
  "toddy", "token", "tonal", "tongs", "tonic", "tooth", "topaz", "topic", "torch", "torso",
